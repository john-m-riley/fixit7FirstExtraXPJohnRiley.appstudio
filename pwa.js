...
const cacheName = 'fixit7FirstExtraXPKyleKidder-2020-11-23 16:46:57.161846'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit7FirstExtraXPKyleKidder'.length) === 'fixit7FirstExtraXPKyleKidder') {
